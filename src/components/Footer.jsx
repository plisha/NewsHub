    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul>
            <li><a href="/">Home</a></li>
            <li><a href="/topic/world">World News</a></li>
        ...
        <div className="footer-section">
          <h4>Categories</h4>
          <ul>
            <li><a href="/topic/cricket-news">Cricket News</a></li>
            <li><a href="/topic/indian-news">Indian News</a></li>
            <li><a href="/topic/health-care">Health Care</a></li>
            <li><a href="/topic/education">Education</a></li>
            <li><a href="/topic/agriculture">Agriculture</a></li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul className="contact-info">
            <li>
              ...
              <a href="mailto:info@newshub.com">info@newshub.com</a>
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="currentColor">
